        ...
        response.json().then(function (data) {
          ...
          data.standings[0].table.forEach(function(teams) {
            ...
            <tr>
              ...
              <td>${teams.team.name}</td>
              <td>
                <a href="detailtim.html?id=${teams.team.id}" class="btn halfway-fab waves-effect waves-light red"><i class="material-icons">list</i></a>
    ...
    data.forEach(function(teams) {
      tblRow += `
          <tr>
            ...
            <td>${teams.name}</td>
            <td>
              <a href="detailtim.html?id=${teams.id}" class="btn halfway-fab waves-effect waves-light red"><i class="material-icons">list</i></a>
